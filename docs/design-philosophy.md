...
**This document is dedicated to the public domain under [CC0](https://creativecommons.org/publicdomain/zero/1.0/).** No permission needed, no attribution required, no need to ask. Take whatever's useful and leave the rest.

## The problem this is a small answer to
